# TODO: this seems to be not necessary anymore, delete if not needed together with the repository function

# def test_obtain_lfn_from_local_file_name(
# app_initialization_container: ApplicationContainer,
# test_file_path: str,
# ) -> None:
# minio_repo: MinIOFileRepository = app_initialization_container.minio_file_repository()

# file_path = test_file_path

# dto = minio_repo.file
# file_path_to_source_data_composite_index(file_path=file_path)
...
# dto = minio_repo.file_path_to_source_data_composite_index(file_path=file_path)
...
# dto = minio_repo.file_path_to_source_data_composite_index(file_path=file_path)  # type: ignore
